...
<body>
	...
	<nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
		<a class="navbar-brand" href="">My Apparel</a>
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
        ...
        @endguest
	<div class="content">
		<img src="https://waspada.co.id/wp-content/uploads/2022/05/Fashion-cowok.jpg" alt="Deskripsi Gambar" style="width: 100%; height: auto;">
		<h1 class="title">MY  Apparel</h1>
		<h3>The Best Apparel</h3>
	</div>
	<div class="container">
		<div class="products">
			...
			<div class="row list-product">
                ...
                <div class="col-lg-4 col-md-6">
					<a href="">
					<img src="{{ asset('storage/images/' . $product->image) }}" alt="nopic" height="150" width="150">
					</a>
